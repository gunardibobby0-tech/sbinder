...
import { ArrowLeft, FileText, Users, CalendarDays, Settings, DollarSign, BarChart3, Film, Images, Layers } from "lucide-react";
...
import { TeamCollaborationDialog } from "@/components/team-collaboration-dialog";
      ...
      <div className="flex flex-col h-[calc(100vh-theme(spacing.20))] lg:h-screen">
        ...
        <div className="bg-[#1c2128] border-b border-white/5 px-6 py-4 flex items-center justify-between sticky top-0 z-10 shadow-md">
          ...
          <div className="flex items-center gap-2">
            <TeamCollaborationDialog projectId={projectId} />
